...
<img width="444" height="141" alt="Screenshot 2026-02-02 at 00 39 28" src="https://github.com/user-attachments/assets/2e33e256-fcc6-4752-a474-ed2fc9ac756a" />

## 🗂️ Data Structure
The dataset contains the following fields:
1. Order Date: Date of the transaction
2. Customer Name: Name of the customer
3. State: U.S. state where the customer is located
4. Category: Product category (Furniture, Office Supplies, Technology)
5. Sub-Category: More specific product classification
6. Product Name: Specific product sold
7. Sales: Revenue generated from the sale
8. Quantity: Number of units sold
9. Profit: Profit amount for the transaction
10. Month: Month of the transaction
...
Identifies the most profitable customers Shows contribution of top customers to overall profitability
...
b. Optimize inventory for peak seasonal periods (Nov-Dec)
c. Analyze underperforming regions for potential market expansion opportunities
d. Consider product bundling strategies that combine high-volume and high-margin items
